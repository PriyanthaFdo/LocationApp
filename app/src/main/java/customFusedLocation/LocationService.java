...
import static customFusedLocation.Constants.CHANNEL_ID;
import static customFusedLocation.Constants.LOGGER_TAG;
import static customFusedLocation.Constants.NOTIFICATION_ID;
import static customFusedLocation.Constants.SERVICE_NOTIFICATION_CONTENT;
import static customFusedLocation.Constants.SERVICE_TITLE;
...
public class LocationService extends Service {
  ...
  private void createNotificationChannel() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Foreground location service", NotificationManager.IMPORTANCE_DEFAULT);
  ...
  private Notification createNotification() {
    NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID).setContentTitle(SERVICE_TITLE).setContentText(SERVICE_NOTIFICATION_CONTENT).setSmallIcon(R.drawable.baseline_my_location_24);
